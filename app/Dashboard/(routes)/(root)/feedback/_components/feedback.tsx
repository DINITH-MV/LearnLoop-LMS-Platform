        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((feedback) => (
            <tr key={feedback.id}>
              ...
              <td className="px-6 w-32 py-4 whitespace-nowrap text-sm text-gray-500">{feedback.messages}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{feedback.reply}</td>
