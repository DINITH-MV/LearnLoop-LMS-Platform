          ...
          <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-5">
              ...
              <div
                ...
                onClick={() =>
                  handleSuggestionClick(
                    "How to write test cases for API with JEST, Mocha and Chai"
                  )
                }
              >
                <p className="text-[#585858] text-lg">
                  How to write test cases for NextJs API with JEST, Mocha and
                  Chai
                </p>
                <Aperture className="w-8 h-8 p-1 absolute bg-white rounded-md bottom-2 right-2" />
              </div>
              ...
              >
                <p className="text-[#585858] text-lg">
                  How to train a machine learning model with langchain in 5
                  minutes
                </p>
                <Aperture className="w-8 h-8 p-1 absolute bg-white rounded-md bottom-2 right-2" />
              </div>
