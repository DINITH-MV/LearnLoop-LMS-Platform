...
export const Section03 = () => {
  ...
  return (
    <div id="second-section" className="relative h-[900px] mt-[165px] flex flex-col items-center justify-center">
      {/* Header Section */}
      <motion.div
        ...
        className="flex items-center justify-center mb-8 transform-gpu translate-x-[var(--x)]"
      >
      ...
      <section ref={targetRef} className="flex items-center justify-center">
        ...
        >
          <div className="w-[820px] max-w-[90vw] grid grid-cols-2 gap-4 rounded-tl-[80px] rounded-tr-[30px] rounded-br-[80px] rounded-bl-[30px] bg-gradient-to-r from-[#ff5a31] to-[#ffe292] border-[20px] border-white p-[15px]">
            {content.map(({ icon: Icon, title, text, link }) => (
              ...
              >
                <span className="mb-[14px] flex h-[72px] w-[72px] items-center justify-center rounded-tl-[27px] rounded-tr-[4px] rounded-bl-[4px] rounded-br-[4px] bg-gradient-to-r from-[#ff5a31] to-[#cb6866]">
